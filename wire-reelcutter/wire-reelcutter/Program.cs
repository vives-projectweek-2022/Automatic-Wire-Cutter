    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (confirmation == "n" || confirmation == "N")
            {
                ...
                {
                    Console.Write("What length of the first part needs to be stripped? (in mm) ");
                    int leftStripped = Convert.ToInt32(Console.ReadLine());
                    
                    Console.WriteLine("received");
                    Console.WriteLine(buffer);
                    Console.Write("What length of the second part needs to be stripped? (in mm) ");
                    int rightStripped = Convert.ToInt32(Console.ReadLine());
                    Console.WriteLine("received");
                    Console.WriteLine(buffer);
                    Console.Write("What's the middle length of the wire? (in mm) ");
                    int middleLength = Convert.ToInt32(Console.ReadLine());
                    Console.WriteLine("received");
                    Console.WriteLine(buffer);
                    Console.Write("What amount of wires need to be stripped? ");
                    int amount = Convert.ToInt32(Console.ReadLine());
                    serialPort.Write($"{leftStripped}{rightStripped}{middleLength}{amount}");
                ...
                else if (cutter == "R" || cutter == "r")
                {
                    ...
                    if (reelnumber == 1 || reelnumber == 2 || reelnumber == 3 || reelnumber == 4)
                    {
                        ...
                        int numberOfComponents = Convert.ToInt32(Console.ReadLine());
                        serialPort.Write($"{numberOfComponents}");
                        serialPort.Read(buffer, 0, 3);
                        Console.WriteLine("received");
                        Console.WriteLine(buffer);
                        Console.Write("How many reels do you want? ");
                        int numberOfReels = Convert.ToInt32(Console.ReadLine());
                        serialPort.Write($"{numberOfReels}");
                        serialPort.Read(buffer, 0, 3);
                        Console.WriteLine("received");
                        Console.WriteLine(buffer);
